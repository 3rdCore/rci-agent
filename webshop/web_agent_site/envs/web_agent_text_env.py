...
from webshop.web_agent_site.engine.engine import (
    load_products,
    init_search_engine,
...
from webshop.web_agent_site.engine.goal import get_reward, get_goals
from webshop.web_agent_site.utils import (
    DEFAULT_FILE_PATH,
    FEAT_CONV,
    FEAT_IDS,
    random_idx,
...
class SimServer:
    ...
    def __init__(
        ...
        (
            ...
            filepath=file_path, num_products=num_products, human_goals=human_goals
        )
